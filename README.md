...
<p align="left">
<p style="font-size:18px">• Programming languages:</p>
...
<p style="font-size:18px">• Web development:</p>
<p style="font-size:16px; margin-left:10px">• Frontend:</p>
...
<p style="font-size:16px; margin-left:10px">• Backend:</p>
...
<p style="font-size:18px">• Miscellaneous:</p>
...
<p style="font-size:18px">• Databases:</p>
...
<p style="font-size:18px">• Mobile development:</p>
